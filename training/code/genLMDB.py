...
sys.path.insert(0, os.path.join('/root/caffe/caffe/', 'python/'))
import caffe
import os.path
import struct
...
def writeLMDB(datasets, lmdb_path, validation):
	...
	for count in range(numSample):
		...
		if "MPI" in data[idx]['dataset']:
			...
			path_header = '/data0/users/mayuchen/Project/Realtime_Multi-Person_Pose_Estimation/training/dataset/COCO/images/'
...
if __name__ == "__main__":
	...
	writeLMDB(['COCO'], '/data0/users/mayuchen/Project/Realtime_Multi-Person_Pose_Estimation/training/dataset/COCO/lmdb1', 1)
